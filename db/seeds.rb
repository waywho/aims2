...
format_summer.highlights.create([{title: "Gala Concert", description: "Stephan Loges, bass-baritone", workflow_state: "published"},
	{title: "Celebrity Masterclass", description: "Kathryn Harris, soprano and Director of National Opera Studio", workflow_state: "published"},
...
Course.delete_all
course_solo = format_summer.courses.create({title: "Solo Course", description: "Our SOLO course is aimed at singers of all ages (18 plus). This could be young professionals on the threshold of a career, students at music colleges, amateurs of 'semi-pro' standard and singers with a little less experience, but a desire to sing really well.", workflow_state: "published"})
course_choral = format_summer.courses.create({title: "Choral Course", description: "Our CHORAL course is open to all. We offer a range of choirs and vocal groups, covering a varied repertoire, catering, we hope, to individual tastes. Crucially, all our choral classes culminate in performances, be it lunctime concerts, or larger choral works with soloists and orchestra.", workflow_state: "published"})
course_cross = format_summer.courses.create({title: "CROSSOVER Course", description: "The CROSSOVER COURSE has become increasingly popular in recent years, offers studetns the chance to 'pick and choose' from the SOLO or CHORAL courses. We feel this gives people a chance to really tailor their week with us, according to their preferences.", workflow_state: "published"})
course_piano = format_summer.courses.create({title: "Piano Accompanist Course", description: "This is a great course for established duos, or for pianists looking to progress. This course is very much tailored to individual needs: you may be following a particular singer throughout their week, or you may be partnered with different singers, according to your preference and areas of interest. The aim is to produce and individual learning and performance opportunities with some of the best accompanist tutors."})
course_other = format_summer.courses.create({title: "Other Course", description: "New in 2016, we have space for up to six students to take choral conducting classes with Gregory Rose. Students will need to be enrolled as either a choral or a crossover singing student, and alongside singing classes, they will work with Gregory on stick technique, observing and conducting.", workflow_state: "published"})
course_dropin = format_summer.courses.create({title: "Drop-In Course", description: "Open to all students, by signing up in the onsite AIMS Office."})
...
Page.create({title: "Contact Us", content: "I will call you", workflow_state: "published"})
Page.create({title: "About Us", content: "We are just brilliant", workflow_state: "published"})
...
Quote.delete_all
Quote.create({saying: "Fabulous week at AIMS but then it always is! Lovely to see old friends and meet new ones, and share in this life-enhancing musical experience.", workflow_state: "published"})
Quote.create({saying: "As the week progressed, it was nice to know we all shared the same vocal issues.", workflow_state: "published"})
